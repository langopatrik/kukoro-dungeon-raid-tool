...
const I18N = {
  en: {
    ...
    faq_a5: 'The website automatically tracks the end of the raid, and clears the board. For manual clear,
click "Disconnect" to leave the channel, then "Clear" to reset the chat log and Board.',
